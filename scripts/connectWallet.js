...
const stakingContractAddress = '0xEA6AC212caed7a51C69CB33350d1487aB2f8Cf1D';
...
// Função para obter o fornecimento circulante de DRIPS
window.getDripsTotalSupply = async function() {
    try {
        const dripstotalSupply = await window.dripsTokenContract.methods.totalSupply().call();
        return dripstotalSupply;
    } catch (error) {
        console.error('Erro ao obter o fornecimento circulante de DRIPS:', error);
        throw error;
    }
}
